...
export async function POST(req: NextRequest) {
  ...
  // Keep only last MAX_HISTORY * 2 messages to control context size
  ...
  try {
    ...
    reply =
      "I'm having a little trouble right now. Please WhatsApp us at " +
      "+91 99351 13011 and our team will help you instantly!";
  }
...
// Cleanup expired sessions (run on server startup or via cron)
